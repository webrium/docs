...
- [Eloquent ORM](./eloquent.md) — define models and query them with the same fluent syntax
- [Collections](./collections.md) — transform and inspect the `data` returned by the paginator