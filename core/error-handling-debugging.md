...
Webrium provides a unified error and exception handler that controls how problems are displayed, logged, and rendered — for both development and production environments. It catches PHP errors, warnings, notices, exceptions, and fatal shutdown errors through a single pipeline.
